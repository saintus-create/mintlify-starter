...
description: 'Documentation Platform gives you complete control over the look and feel of your documentation using the docs.json file'
icon: 'gearshape.fill'
---

Every Documentation Platform site needs a `docs.json` file with the core configuration settings. Learn more about the [properties](#properties) below.
...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  ...
  <Expandable title="TopbarLink">
    ...
    The url once you click on the button. Example: `https://docs-clilify.com/docs`
    </ResponseField>
...
<ResponseField name="footerSocials" type="FooterSocials">
  ...
  ```json
  {
    "x": "https://x.com/docs-clilify",
    "website": "https://docs-clilify.com"
  }
  ```
  <Expandable title="FooterSocials">
    ...
    Example: `https://x.com/docs-clilify`
    </ResponseField>
  </Expandable>
</ResponseField>
